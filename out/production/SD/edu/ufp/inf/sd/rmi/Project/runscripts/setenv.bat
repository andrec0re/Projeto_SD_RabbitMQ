...
@Set EXCHANGE_NAME_PREFIX=client
@Set FRONT_SERVER_PREFIX=FrontServer
...
@Set BROKER_QUEUE_FRONTSERVER=%FRONT_SERVER_PREFIX%_queue
@Set BROKER_EXCHANGE=%EXCHANGE_NAME_PREFIX%
