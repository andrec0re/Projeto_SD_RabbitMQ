...
public class LoadImages {
	...
	public LoadImages() {
		...
		Game.img_char = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/Project/client/img/"+"Units"+".png"));
		Game.img_tile = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/Project/client/img/"+"Terrain"+".png"));
		Game.img_city = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/Project/client/img/"+"Cities"+".png"));
		Game.img_exts = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/Project/client/img/"+"Extras"+".png"));
		Game.img_plys = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/Project/client/img/"+"Players"+".png"));
		Game.img_menu[0] = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/Project/client/img/"+"GameInfo"+".png"));
	}
