...
public class Gui extends JPanel {
	...
	public void LoginScreen() {
		...
		removeAll();
		new edu.ufp.inf.sd.rmi.Project.client.menus.StartMenu();
	...
	public void paintComponent(Graphics g) {
		...
		case PLAYING:
			...
			edu.ufp.inf.sd.rmi.Project.client.gui.Terrain.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rmi.Project.client.gui.Ranges.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rmi.Project.client.gui.Cities.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rmi.Project.client.gui.Units.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rmi.Project.client.gui.Selector.Draw(frame, gg, Game.ScreenBase,
					Game.player.get(Game.btl.currentplayer).selectx,
					Game.player.get(Game.btl.currentplayer).selecty);
			edu.ufp.inf.sd.rmi.Project.client.gui.SmallMenu.Draw(gg,frame);
		break;
		case EDITOR:
			gg.setColor(new Color(0,0,60));
			gg.fillRect(0, 0, width, height);
